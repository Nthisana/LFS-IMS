...
// Fetch ONLY coffins with status = Write-off
$stmt = $conn->prepare("SELECT * FROM coffins WHERE LOWER(TRIM(status)) = 'Write-off'");
$stmt->execute();
