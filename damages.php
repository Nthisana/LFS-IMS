...
// Fetch ONLY coffins with status = Damage
$stmt = $conn->prepare("SELECT * FROM coffins WHERE LOWER(TRIM(status)) = 'Damage'");
$stmt->execute();
