...
$restrictedPages = ['database.php', 'credentials.php', 'coffin_trail.php'];
...
<div id="hamburgerMenu" class="hamburger-menu">
    ...
    <button onclick="navigateTo('coffin_trail.php')">Coffin Trail</button>
    <button onclick="navigateTo('request_trail.php')">Request Trail</button>
...
<div class="filters">
    ...
    <select id="storageFilter"><option value="">Storage</option></select>
</div>

<div class="stats">
    <div class="card" id="inStock">In-stock: <?php echo $counts['In-stock']; ?></div>
    <div class="card" id="sold">Sold: <?php echo $counts['Sold']; ?></div>
    <div class="card" id="transfer">Transfer: <?php echo $counts['Transfer']; ?></div>
    <div class="card" id="writeoff">Write-off: <?php echo $counts['Write-off']; ?></div>
    <div class="card" id="total">Total: <?php echo $counts['Total']; ?></div>
</div>
...
// Allowing Admins to access all pages (Protect admin-only pages)
