...
$stmt = $conn->query("SELECT * FROM coffin_trail ORDER BY updated_at DESC");
...
<body>
<a href="index.php" style="display: inline-block; margin-bottom: 15px; padding: 6px 12px; background-color:rgb(117, 78, 0); color: white; text-decoration: none; border-radius: 4px;"> ← Back </a>
